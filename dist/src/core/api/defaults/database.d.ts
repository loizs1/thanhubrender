 ...
 */
export declare class ODDatabaseManager_Default extends ODDatabaseManager {
 ...
 */
export declare class ODFormattedJsonDatabase_DefaultGlobal extends ODFormattedJsonDatabase {
    ...
    getCategory<CategoryId extends keyof ODFormattedJsonDatabaseIds_DefaultGlobal>(category: CategoryId): ODOptionalPromise<{
        key: string;
        value: ODFormattedJsonDatabaseIds_DefaultGlobal[CategoryId];
    }[] | undefined>;
 ...
 */
export declare class ODFormattedJsonDatabase_DefaultTickets extends ODFormattedJsonDatabase {
    ...
    exists(category: string, key: string): ODOptionalPromise<boolean>;
    getCategory<CategoryId extends keyof ODFormattedJsonDatabaseIds_DefaultTickets>(category: CategoryId): ODOptionalPromise<{
        key: string;
        value: ODFormattedJsonDatabaseIds_DefaultTickets[CategoryId];
    }[] | undefined>;
    getCategory(category: string): ODOptionalPromise<{
        key: string;
        value: ODValidJsonType;
 ...
 */
export declare class ODFormattedJsonDatabase_DefaultUsers extends ODFormattedJsonDatabase {
    ...
    exists(category: string, key: string): ODOptionalPromise<boolean>;
    getCategory<CategoryId extends keyof ODFormattedJsonDatabaseIds_DefaultUsers>(category: CategoryId): ODOptionalPromise<{
        key: string;
        value: ODFormattedJsonDatabaseIds_DefaultUsers[CategoryId];
    }[] | undefined>;
    getCategory(category: string): ODOptionalPromise<{
        key: string;
        value: ODValidJsonType;
 ...
 */
export declare class ODFormattedJsonDatabase_DefaultOptions extends ODFormattedJsonDatabase {
    ...
    exists(category: string, key: string): ODOptionalPromise<boolean>;
    getCategory<CategoryId extends keyof ODFormattedJsonDatabaseIds_DefaultOptions>(category: CategoryId): ODOptionalPromise<{
        key: string;
        value: ODFormattedJsonDatabaseIds_DefaultOptions[CategoryId];
    }[] | undefined>;
    getCategory(category: string): ODOptionalPromise<{
        key: string;
        value: ODValidJsonType;
