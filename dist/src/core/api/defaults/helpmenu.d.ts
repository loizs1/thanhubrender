 ...
 */
export declare class ODHelpMenuManager_Default extends ODHelpMenuManager {
 ...
 */
export declare class ODHelpMenuCategory_DefaultGeneral extends ODHelpMenuCategory {
 ...
 */
export declare class ODHelpMenuCategory_DefaultTicketBasic extends ODHelpMenuCategory {
 ...
 * This default class is made for the `opendiscord:ticket` category in `opendiscord.helpmenu`!
 */
export declare class ODHelpMenuCategory_DefaultTicketAdvanced extends ODHelpMenuCategory {
 ...
 * This default class is made for the `opendiscord:ticket` category in `opendiscord.helpmenu`!
 */
export declare class ODHelpMenuCategory_DefaultTicketUser extends ODHelpMenuCategory {
 ...
 */
export declare class ODHelpMenuCategory_DefaultAdmin extends ODHelpMenuCategory {
 ...
 */
export declare class ODHelpMenuCategory_DefaultAdvanced extends ODHelpMenuCategory {
 ...
 * This default class is made for the `opendiscord:general` category in `opendiscord.helpmenu`!
 */
export declare class ODHelpMenuCategory_DefaultExtra extends ODHelpMenuCategory {
