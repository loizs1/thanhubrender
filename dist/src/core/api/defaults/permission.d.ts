 ...
 */
export declare class ODPermissionManager_Default extends ODPermissionManager {
 ...
 */
export type ODPermissionEmbedType = ("developer" | "owner" | "admin" | "moderator" | "support" | "member" | "discord-administrator");
