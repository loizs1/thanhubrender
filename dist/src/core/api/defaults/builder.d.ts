 ...
 */
export declare class ODBuilderManager_Default extends ODBuilderManager {
    buttons: ODButtonManager_Default;
    dropdowns: ODDropdownManager_Default;
    files: ODFileManager_Default;
    embeds: ODEmbedManager_Default;
    messages: ODMessageManager_Default;
    modals: ODModalManager_Default;
}
...
export interface ODButtonManagerIds_Default {
    "opendiscord:verifybar-success": {
        ...
        params: {
            ...
            customData?: string;
            customColor?: ODValidButtonColor;
            customLabel?: string;
            customEmoji?: string;
        };
        workers: "opendiscord:verifybar-success";
    };
    "opendiscord:verifybar-failure": {
        ...
        workers: "opendiscord:verifybar-failure";
    };
    "opendiscord:error-ticket-deprecated-transcript": {
        source: "slash" | "text" | "button" | "dropdown" | "modal" | "other";
        params: {};
        workers: "opendiscord:error-ticket-deprecated-transcript";
    };
    "opendiscord:help-menu-previous": {
        source: "text" | "slash" | "button" | "other";
        params: {
            mode: "slash" | "text";
            page: number;
        };
        workers: "opendiscord:help-menu-previous";
    };
    "opendiscord:help-menu-next": {
        ...
        workers: "opendiscord:help-menu-next";
    };
    "opendiscord:help-menu-page": {
        ...
        workers: "opendiscord:help-menu-page";
    };
    "opendiscord:help-menu-switch": {
        ...
        workers: "opendiscord:help-menu-switch";
    };
    ...
    "opendiscord:website-option": {
        ...
        params: {
            ...
            user: discord.User;
            panel: ODPanel;
            option: ODWebsiteOption;
        };
        workers: "opendiscord:website-option";
    };
    ...
    "opendiscord:visit-ticket": {
        source: "ticket-created" | "dm" | "logs" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
        ...
        workers: "opendiscord:visit-ticket";
    };
    "opendiscord:close-ticket": {
        source: "ticket-message" | "reopen-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:delete-ticket": {
        source: "ticket-message" | "close-message" | "autoclose-message" | "reopen-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:reopen-ticket": {
        source: "ticket-message" | "close-message" | "autoclose-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:claim-ticket": {
        source: "ticket-message" | "unclaim-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:unclaim-ticket": {
        source: "ticket-message" | "claim-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:pin-ticket": {
        source: "ticket-message" | "unpin-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:unpin-ticket": {
        source: "ticket-message" | "pin-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
    ...
    "opendiscord:transcript-html-visit": {
        source: "channel" | "creator-dm" | "participant-dm" | "active-admin-dm" | "every-admin-dm" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
            user: discord.User;
            ticket: ODTicket;
            compiler: ODTranscriptCompiler<{
                url: string;
                availableUntil: Date;
            }, {
                auth: string;
        ...
        workers: "opendiscord:transcript-html-visit";
    };
    "opendiscord:transcript-error-retry": {
        ...
        params: {
            ...
            user: discord.User;
            ticket: ODTicket;
            compiler: ODTranscriptCompiler<any, object | null>;
            reason: string | null;
        };
        workers: "opendiscord:transcript-error-retry";
    };
    "opendiscord:transcript-error-continue": {
        ...
        workers: "opendiscord:transcript-error-continue";
    };
 ...
 */
export declare class ODButtonManager_Default extends ODButtonManager {
 ...
 */
export declare class ODButton_Default<Source extends string, Params, WorkerIds extends string> extends ODButton<Source, Params> {
    workers: ODWorkerManager_Default<ODButtonInstance, Source, Params, WorkerIds>;
}
 ...
 */
export declare class ODDropdownManager_Default extends ODDropdownManager {
 ...
 */
export declare class ODDropdown_Default<Source extends string, Params, WorkerIds extends string> extends ODDropdown<Source, Params> {
    workers: ODWorkerManager_Default<ODDropdownInstance, Source, Params, WorkerIds>;
}
...
export interface ODFileManagerIds_Default {
    "opendiscord:text-transcript": {
        ...
        params: {
            ...
            ticket: ODTicket;
            compiler: ODTranscriptCompiler<any, object | null>;
            result: ODTranscriptCompilerCompileResult<any>;
        };
 ...
 */
export declare class ODFileManager_Default extends ODFileManager {
 ...
 */
export declare class ODFile_Default<Source extends string, Params, WorkerIds extends string> extends ODFile<Source, Params> {
    workers: ODWorkerManager_Default<ODFileInstance, Source, Params, WorkerIds>;
}
...
export interface ODEmbedManagerIds_Default {
    ...
    "opendiscord:error-option-missing": {
        ...
        params: {
            ...
            channel: discord.TextBasedChannel;
            user: discord.User;
            error: ODTextCommandErrorMissingOption;
        };
        workers: "opendiscord:error-option-missing";
    };
    "opendiscord:error-option-invalid": {
        ...
        params: {
            ...
            channel: discord.TextBasedChannel;
            user: discord.User;
            error: ODTextCommandErrorInvalidOption;
        };
        workers: "opendiscord:error-option-invalid";
    };
    "opendiscord:error-unknown-command": {
        ...
        params: {
            ...
            channel: discord.TextBasedChannel;
            user: discord.User;
            error: ODTextCommandErrorUnknownCommand;
        };
        workers: "opendiscord:error-unknown-command";
    };
    "opendiscord:error-no-permissions": {
        ...
        params: {
            ...
            channel: discord.TextBasedChannel;
            user: discord.User;
            permissions: ODPermissionEmbedType[];
        };
        workers: "opendiscord:error-no-permissions";
    };
    "opendiscord:error-no-permissions-cooldown": {
        ...
        workers: "opendiscord:error-no-permissions-cooldown";
    };
    "opendiscord:error-no-permissions-blacklisted": {
        ...
        workers: "opendiscord:error-no-permissions-blacklisted";
    };
    "opendiscord:error-no-permissions-limits": {
        ...
        params: {
            ...
            channel: discord.TextBasedChannel;
            user: discord.User;
            limit: "global" | "global-user" | "option" | "option-user";
        };
        workers: "opendiscord:error-no-permissions-limits";
    };
    "opendiscord:error-responder-timeout": {
        ...
        workers: "opendiscord:error-responder-timeout";
    };
    "opendiscord:error-ticket-unknown": {
        ...
        workers: "opendiscord:error-ticket-unknown";
    };
    "opendiscord:error-ticket-deprecated": {
        ...
        workers: "opendiscord:error-ticket-deprecated";
    };
    "opendiscord:error-option-unknown": {
        ...
        workers: "opendiscord:error-option-unknown";
    };
    "opendiscord:error-panel-unknown": {
        ...
        workers: "opendiscord:error-panel-unknown";
    };
    "opendiscord:error-not-in-guild": {
        ...
        workers: "opendiscord:error-not-in-guild";
    };
    "opendiscord:error-channel-rename": {
        source: "slash" | "text" | "button" | "dropdown" | "modal" | "ticket-pin" | "ticket-unpin" | "ticket-rename" | "ticket-move" | "ticket-priority" | "ticket-transfer" | "other";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
            user: discord.User;
        ...
        workers: "opendiscord:error-channel-rename";
    };
    "opendiscord:error-ticket-busy": {
        ...
        workers: "opendiscord:error-ticket-busy";
    };
    "opendiscord:help-menu": {
        source: "text" | "slash" | "button" | "other";
        params: {
            mode: "slash" | "text";
            page: number;
        };
        workers: "opendiscord:help-menu";
    };
    "opendiscord:stats-global": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:stats-global";
    };
    "opendiscord:stats-ticket": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:stats-ticket";
    };
    "opendiscord:stats-user": {
        ...
        params: {
            ...
            channel: discord.TextBasedChannel;
            user: discord.User;
            scopeData: discord.User;
        };
        workers: "opendiscord:stats-user" | "opendiscord:easter-egg";
    };
    "opendiscord:stats-reset": {
        ...
        workers: "opendiscord:stats-reset";
    };
    "opendiscord:stats-ticket-unknown": {
        ...
        workers: "opendiscord:stats-ticket-unknown";
    };
    "opendiscord:panel": {
        source: "slash" | "text" | "auto-update" | "other";
        params: {
        ...
        workers: "opendiscord:panel";
    };
    "opendiscord:ticket-created": {
        ...
        workers: "opendiscord:ticket-created";
    };
    "opendiscord:ticket-created-dm": {
        source: "panel-button" | "panel-dropdown" | "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:ticket-created-dm";
    };
    "opendiscord:ticket-created-logs": {
        ...
        workers: "opendiscord:ticket-created-logs";
    };
    "opendiscord:ticket-message": {
        ...
        workers: "opendiscord:ticket-message";
    };
    "opendiscord:close-message": {
        ...
        workers: "opendiscord:close-message";
    };
    "opendiscord:reopen-message": {
        ...
        workers: "opendiscord:reopen-message";
    };
    "opendiscord:delete-message": {
        source: "slash" | "text" | "ticket-message" | "reopen-message" | "close-message" | "autoclose-message" | "autodelete" | "clear" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:delete-message";
    };
    "opendiscord:claim-message": {
        ...
        workers: "opendiscord:claim-message";
    };
    "opendiscord:unclaim-message": {
        ...
        workers: "opendiscord:unclaim-message";
    };
    "opendiscord:pin-message": {
        ...
        workers: "opendiscord:pin-message";
    };
    "opendiscord:unpin-message": {
        ...
        workers: "opendiscord:unpin-message";
    };
    "opendiscord:rename-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:rename-message";
    };
    "opendiscord:move-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:move-message";
    };
    "opendiscord:add-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:add-message";
    };
    "opendiscord:remove-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:remove-message";
    };
    "opendiscord:ticket-action-dm": {
        source: "slash" | "text" | "ticket-message" | "close-message" | "reopen-message" | "delete-message" | "claim-message" | "unclaim-message" | "pin-message" | "unpin-message" | "autoclose-message" | "autoclose" | "autodelete" | "clear" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
            mode: "close" | "reopen" | "delete" | "claim" | "unclaim" | "pin" | "unpin" | "rename" | "move" | "add" | "remove";
            ticket: ODTicket;
            reason: string | null;
            additionalData: null | string | discord.User | ODTicketOption;
        };
        workers: "opendiscord:ticket-action-dm";
    };
    "opendiscord:ticket-action-logs": {
        ...
        workers: "opendiscord:ticket-action-logs";
    };
    "opendiscord:blacklist-view": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:blacklist-view";
    };
    "opendiscord:blacklist-get": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:blacklist-get";
    };
    "opendiscord:blacklist-add": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:blacklist-add";
    };
    "opendiscord:blacklist-remove": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:blacklist-remove";
    };
    "opendiscord:blacklist-dm": {
        ...
        workers: "opendiscord:blacklist-dm";
    };
    "opendiscord:blacklist-logs": {
        ...
        workers: "opendiscord:blacklist-logs";
    };
    "opendiscord:transcript-text-ready": {
        source: "channel" | "creator-dm" | "participant-dm" | "active-admin-dm" | "every-admin-dm" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:transcript-text-ready";
    };
    "opendiscord:transcript-html-ready": {
        source: "channel" | "creator-dm" | "participant-dm" | "active-admin-dm" | "every-admin-dm" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:transcript-html-ready";
    };
    "opendiscord:transcript-html-progress": {
        ...
        workers: "opendiscord:transcript-html-progress";
    };
    ...
    "opendiscord:reaction-role": {
        ...
        params: {
            ...
            user: discord.User;
            role: ODRole;
            result: ODRoleUpdateResult[];
        };
        workers: "opendiscord:reaction-role";
    };
    "opendiscord:reaction-role-dm": {
        source: "panel-button" | "other";
        params: {
            guild: discord.Guild;
            user: discord.User;
        ...
        workers: "opendiscord:reaction-role-dm";
    };
    "opendiscord:reaction-role-logs": {
        source: "panel-button" | "other";
        params: {
            guild: discord.Guild;
            user: discord.User;
        ...
        workers: "opendiscord:reaction-role-logs";
    };
    "opendiscord:clear-verify-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:clear-verify-message";
    };
    "opendiscord:clear-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:clear-message";
    };
    "opendiscord:clear-logs": {
        ...
        workers: "opendiscord:clear-logs";
    };
    "opendiscord:autoclose-message": {
        source: "timeout" | "leave" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
            user: discord.User;
        ...
        workers: "opendiscord:autoclose-message";
    };
    "opendiscord:autodelete-message": {
        source: "timeout" | "leave" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:autodelete-message";
    };
    "opendiscord:autoclose-enable": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:autoclose-enable";
    };
    "opendiscord:autodelete-enable": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:autodelete-enable";
    };
    "opendiscord:autoclose-disable": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:autoclose-disable";
    };
    "opendiscord:autodelete-disable": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:autodelete-disable";
    };
    "opendiscord:topic-set": {
        ...
        workers: "opendiscord:topic-set";
    };
    "opendiscord:priority-set": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
            user: discord.User;
            ticket: ODTicket;
            priority: ODPriorityLevel;
            reason: string | null;
        };
        workers: "opendiscord:priority-set";
    };
    "opendiscord:priority-get": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
        ...
        workers: "opendiscord:priority-get";
    };
    "opendiscord:transfer-message": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.GuildTextBasedChannel;
            user: discord.User;
            ticket: ODTicket;
            oldCreator: discord.User;
            newCreator: discord.User;
            reason: string | null;
        };
        workers: "opendiscord:transfer-message";
    };
}
 ...
 */
export declare class ODEmbedManager_Default extends ODEmbedManager {
 ...
 */
export declare class ODEmbed_Default<Source extends string, Params, WorkerIds extends string> extends ODEmbed<Source, Params> {
    workers: ODWorkerManager_Default<ODEmbedInstance, Source, Params, WorkerIds>;
}
...
export interface ODMessageManagerIds_Default {
    "opendiscord:verifybar-ticket-message": {
        ...
        workers: "opendiscord:verifybar-ticket-message";
    };
    "opendiscord:verifybar-close-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-close-message";
    };
    "opendiscord:verifybar-reopen-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-reopen-message";
    };
    "opendiscord:verifybar-claim-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-claim-message";
    };
    "opendiscord:verifybar-unclaim-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-unclaim-message";
    };
    "opendiscord:verifybar-pin-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-pin-message";
    };
    "opendiscord:verifybar-unpin-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-unpin-message";
    };
    "opendiscord:verifybar-autoclose-message": {
        source: "verifybar";
        params: {
            guild: discord.Guild | null;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:verifybar-autoclose-message";
    };
    "opendiscord:error": {
        source: "slash" | "text" | "button" | "dropdown" | "modal" | "other";
        params: {
    ...
    "opendiscord:help-menu": {
        source: "slash" | "text" | "button" | "other";
        params: {
            mode: "slash" | "text";
            page: number;
        };
    ...
    "opendiscord:panel": {
        ...
        workers: "opendiscord:panel-layout" | "opendiscord:panel-components";
    };
    "opendiscord:panel-ready": {
        source: "slash" | "text" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
        ...
        workers: "opendiscord:panel-ready";
    };
    "opendiscord:ticket-created": {
        source: "panel-button" | "panel-dropdown" | "slash" | "text" | "other";
        params: {
    ...
    "opendiscord:ticket-message": {
        ...
        workers: "opendiscord:ticket-message-layout" | "opendiscord:ticket-message-components" | "opendiscord:ticket-message-disable-components";
    };
    "opendiscord:close-message": {
        source: "slash" | "text" | "ticket-message" | "reopen-message" | "autoclose" | "other";
        params: {
 ...
 */
export declare class ODMessageManager_Default extends ODMessageManager {
 ...
 */
export declare class ODMessage_Default<Source extends string, Params, WorkerIds extends string> extends ODMessage<Source, Params> {
    workers: ODWorkerManager_Default<ODMessageInstance, Source, Params, WorkerIds>;
}
...
export interface ODModalManagerIds_Default {
    ...
    "opendiscord:delete-ticket-reason": {
        source: "ticket-message" | "reopen-message" | "close-message" | "autoclose-message" | "other";
        params: {
            guild: discord.Guild;
            channel: discord.TextBasedChannel;
            user: discord.User;
 ...
 */
export declare class ODModalManager_Default extends ODModalManager {
 ...
 */
export declare class ODModal_Default<Source extends string, Params, WorkerIds extends string> extends ODModal<Source, Params> {
    workers: ODWorkerManager_Default<ODModalInstance, Source, Params, WorkerIds>;
}
