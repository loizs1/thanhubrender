...
export interface ODActionManagerIds_Default {
    "opendiscord:create-ticket-permissions": {
        ...
        result: {
            valid: boolean;
            reason: "blacklist" | "cooldown" | "global-limit" | "global-user-limit" | "option-limit" | "option-user-limit" | "custom" | null;
            cooldownUntil?: Date;
            customReason?: string;
        };
    ...
    "opendiscord:create-transcript": {
        ...
        result: {
            ...
            pendingMessage: ODMessageBuildSentResult<true> | null;
    ...
    "opendiscord:reaction-role": {
        ...
        params: {
            ...
            user: discord.User;
            option: ODRoleOption;
            overwriteMode: ODRoleUpdateMode | null;
        };
        result: {
 ...
 */
export declare class ODActionManager_Default extends ODActionManager {
 ...
 */
export declare class ODAction_Default<Source extends string, Params extends object, Result extends object, WorkerIds extends string> extends ODAction<Source, Params, Result> {
    workers: ODWorkerManager_Default<Result, Source, Params, WorkerIds>;
}
