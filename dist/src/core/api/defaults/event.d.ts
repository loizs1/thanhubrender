...
import { ODError } from "../modules/console";
import { ODCheckerResult } from "../modules/checker";
 ...
 */
export declare class ODEventManager_Default extends ODEventManager {
 ...
 * This default class is made for the global variable `opendiscord.events`!
 */
export declare class ODEvent_Default<Callback extends ((...args: any) => ODPromiseVoid)> extends ODEvent {
