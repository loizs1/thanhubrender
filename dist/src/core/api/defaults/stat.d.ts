 ...
 */
export declare class ODStatsManager_Default extends ODStatsManager {
 ...
 */
export declare class ODStatGlobalScope_DefaultGlobal extends ODStatGlobalScope {
    ...
    getAllStats<StatsId extends keyof ODStatGlobalScopeIds_DefaultGlobal>(id: StatsId): Promise<{
        id: string;
 ...
 */
export declare class ODStatGlobalScope_DefaultSystem extends ODStatGlobalScope {
    ...
    getStat(id: ODValidId): Promise<ODValidStatValue | null>;
    getAllStats<StatsId extends keyof ODStatGlobalScopeIds_DefaultSystem>(id: StatsId): Promise<{
        id: string;
        value: ODValidStatValue;
    }[]>;
    getAllStats(id: ODValidId): Promise<{
 ...
 */
export declare class ODStatScope_DefaultUser extends ODStatScope {
    ...
    getAllStats<StatsId extends keyof ODStatScopeIds_DefaultUser>(id: StatsId): Promise<{
        id: string;
        value: ODValidStatValue;
    }[]>;
    getAllStats(id: ODValidId): Promise<{
 ...
 */
export declare class ODStatScope_DefaultTicket extends ODStatScope {
    ...
    getStat(id: ODValidId, scopeId: string): Promise<ODValidStatValue | null>;
    getAllStats<StatsId extends keyof ODStatScopeIds_DefaultTicket>(id: StatsId): Promise<{
        id: string;
        value: ODValidStatValue;
    }[]>;
    getAllStats(id: ODValidId): Promise<{
 ...
 */
export declare class ODStatScope_DefaultParticipants extends ODStatScope {
    ...
    getStat(id: ODValidId, scopeId: string): Promise<ODValidStatValue | null>;
    getAllStats<StatsId extends keyof ODStatScopeIds_DefaultParticipants>(id: StatsId): Promise<{
        id: string;
        value: ODValidStatValue;
    }[]>;
    getAllStats(id: ODValidId): Promise<{
 ...
 * This default class is made for the `opendiscord:participants` category in `opendiscord.stats`!
 */
export declare class ODStatScope_DefaultMessages extends ODStatScope {
    ...
    getStat(id: ODValidId, scopeId: string): Promise<ODValidStatValue | null>;
    getAllStats<StatsId extends keyof ODStatScopeIds_DefaultMessages>(id: StatsId): Promise<{
        id: string;
        value: ODValidStatValue;
    }[]>;
    getAllStats(id: ODValidId): Promise<{
