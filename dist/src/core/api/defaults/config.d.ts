 ...
 */
export declare class ODConfigManager_Default extends ODConfigManager {
...
export interface ODJsonConfig_DefaultSystemPermissions {
    ...
    leaderboard: ODJsonConfig_DefaultCmdPermissionSettingsType;
}
 ...
 */
export declare class ODJsonConfig_DefaultGeneral extends ODJsonConfig {
    data: ODJsonConfig_DefaultGeneralData;
}
...
export interface ODJsonConfig_DefaultOptionTicketType extends ODJsonConfig_DefaultOptionType {
    ...
    questions: string[];
    /**A list of discord role ids which are able to see this ticket option in the panel. */
    roles: string[];
 ...
 */
export declare class ODJsonConfig_DefaultOptions extends ODJsonConfig {
    data: ODJsonConfig_DefaultOptionsData;
}
 ...
 */
export declare class ODJsonConfig_DefaultPanels extends ODJsonConfig {
    data: ODJsonConfig_DefaultPanelsData;
}
 ...
 */
export declare class ODJsonConfig_DefaultQuestions extends ODJsonConfig {
    data: ODJsonConfig_DefaultQuestionsData;
}
 ...
 */
export declare class ODJsonConfig_DefaultTranscripts extends ODJsonConfig {
    data: ODJsonConfig_DefaultTranscriptsData;
}
