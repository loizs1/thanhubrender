...
exports.defaultTranscriptsFormatter = exports.defaultPanelsFormatter = exports.defaultOptionsFormatter = exports.defaultQuestionsFormatter = exports.defaultGeneralFormatter = exports.loadAllConfigs = void 0;
...
const loadAllConfigs = async () => {
    ...
    index_1.opendiscord.configs.add(new index_1.api.ODJsonConfig("opendiscord:general", "general.json", (isDevconfig) ? "./devconfig/" : "./config/", exports.defaultGeneralFormatter));
    index_1.opendiscord.configs.add(new index_1.api.ODJsonConfig("opendiscord:questions", "questions.json", (isDevconfig) ? "./devconfig/" : "./config/", exports.defaultQuestionsFormatter));
    index_1.opendiscord.configs.add(new index_1.api.ODJsonConfig("opendiscord:options", "options.json", (isDevconfig) ? "./devconfig/" : "./config/", exports.defaultOptionsFormatter));
    index_1.opendiscord.configs.add(new index_1.api.ODJsonConfig("opendiscord:panels", "panels.json", (isDevconfig) ? "./devconfig/" : "./config/", exports.defaultPanelsFormatter));
    index_1.opendiscord.configs.add(new index_1.api.ODJsonConfig("opendiscord:transcripts", "transcripts.json", (isDevconfig) ? "./devconfig/" : "./config/", exports.defaultTranscriptsFormatter));
};
exports.loadAllConfigs = loadAllConfigs;
//FORMATTERS
exports.defaultGeneralFormatter = new fjs.ObjectFormatter(null, true, [
...
exports.defaultQuestionsFormatter = new fjs.ArrayFormatter(null, true, new fjs.ObjectSwitchFormatter(null, [
...
exports.defaultOptionsFormatter = new fjs.ArrayFormatter(null, true, new fjs.ObjectSwitchFormatter(null, [
...
exports.defaultPanelsFormatter = new fjs.ArrayFormatter(null, true, new fjs.ObjectFormatter(null, true, [
    new fjs.PropertyFormatter("id"),
    new fjs.PropertyFormatter("name"),
...
exports.defaultTranscriptsFormatter = new fjs.ObjectFormatter(null, true, [
