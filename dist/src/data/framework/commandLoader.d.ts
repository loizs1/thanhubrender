 ...
 */
export declare const loadAllSlashCommands: () => Promise<void>;
export declare const loadAllTextCommands: () => Promise<void>;
export declare const loadAllContextMenus: () => Promise<void>;
