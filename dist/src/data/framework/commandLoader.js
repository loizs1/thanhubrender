...
exports.loadAllContextMenus = exports.loadAllTextCommands = exports.loadAllSlashCommands = void 0;
 ...
 */
const loadAllSlashCommands = async () => {
    const commands = index_1.opendiscord.client.slashCommands;
    ...
    if (!generalConfig.data.slashCommands)
        return;
    const allowedCommands = [];
    for (const key in generalConfig.data.system.permissions) {
        if (generalConfig.data.system.permissions[key] != "none")
            allowedCommands.push(key);
    }
    //HELP
    if (allowedCommands.includes("help"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:help", {
            type: act.ChatInput,
            name: "help",
    ...
    //PANEL
    if (allowedCommands.includes("panel"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:panel", {
            type: act.ChatInput,
            name: "panel",
    ...
    //TICKET (when enabled)
    if (allowedCommands.includes("ticket"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:ticket", {
            type: act.ChatInput,
            name: "ticket",
    ...
    //CLOSE
    if (allowedCommands.includes("close"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:close", {
            type: act.ChatInput,
            name: "close",
    ...
    //DELETE
    if (allowedCommands.includes("delete") && generalConfig.data.system.enableDeleteWithoutTranscript)
        commands.add(new index_1.api.ODSlashCommand("opendiscord:delete", {
            type: act.ChatInput,
            name: "delete",
    ...
    else if (allowedCommands.includes("delete"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:delete", {
            type: act.ChatInput,
            name: "delete",
            description: lang.getTranslation("commands.delete"),
    ...
    //REOPEN
    if (allowedCommands.includes("reopen"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:reopen", {
            type: act.ChatInput,
            name: "reopen",
    ...
    //CLAIM
    if (allowedCommands.includes("claim"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:claim", {
            type: act.ChatInput,
            name: "claim",
    ...
    //UNCLAIM
    if (allowedCommands.includes("unclaim"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:unclaim", {
            type: act.ChatInput,
            name: "unclaim",
    ...
    //PIN
    if (allowedCommands.includes("pin"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:pin", {
            type: act.ChatInput,
            name: "pin",
    ...
    //UNPIN
    if (allowedCommands.includes("unpin"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:unpin", {
            type: act.ChatInput,
            name: "unpin",
    ...
    //MOVE
    if (allowedCommands.includes("move"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:move", {
            type: act.ChatInput,
            name: "move",
    ...
    //RENAME
    if (allowedCommands.includes("rename"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:rename", {
            type: act.ChatInput,
            name: "rename",
    ...
    //ADD
    if (allowedCommands.includes("add"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:add", {
            type: act.ChatInput,
            name: "add",
    ...
    //REMOVE
    if (allowedCommands.includes("remove"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:remove", {
            type: act.ChatInput,
            name: "remove",
    ...
    //BLACKLIST
    if (allowedCommands.includes("blacklist"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:blacklist", {
            type: act.ChatInput,
            name: "blacklist",
    ...
    //STATS
    if (allowedCommands.includes("stats"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:stats", {
            type: act.ChatInput,
            name: "stats",
    ...
    if (allowedCommands.includes("clear"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:clear", {
            type: act.ChatInput,
            name: "clear",
    ...
    //AUTOCLOSE
    if (allowedCommands.includes("autoclose"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:autoclose", {
            type: act.ChatInput,
            name: "autoclose",
    ...
    //AUTODELETE
    if (allowedCommands.includes("autodelete"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:autodelete", {
            type: act.ChatInput,
            name: "autodelete",
    ...
    if (allowedCommands.includes("topic"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:topic", {
            type: act.ChatInput,
            name: "topic",
    ...
    //PRIORITY
    if (allowedCommands.includes("priority"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:priority", {
            type: act.ChatInput,
            name: "priority",
                    ...
                    options: [
                        {
                            ...
                            type: acot.String,
                            required: true,
                            choices: index_1.opendiscord.priorities.getAll().sort((a, b) => b.priority - a.priority).map((prio) => ({ value: prio.rawName, name: prio.renderDisplayName() }))
                        },
                        {
                            name: "reason",
                            description: lang.getTranslation("commands.reason"),
    ...
    //TRANSFER
    if (allowedCommands.includes("transfer"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:transfer", {
            type: act.ChatInput,
            name: "transfer",
    ...
    if (allowedCommands.includes("leaderboard"))
        commands.add(new index_1.api.ODSlashCommand("opendiscord:leaderboard", {
            type: act.ChatInput,
            name: "leaderboard",
...
const loadAllTextCommands = async () => {
    const commands = index_1.opendiscord.client.textCommands;
    const generalConfig = index_1.opendiscord.configs.get("opendiscord:general");
    if (!generalConfig)
        return;
    if (!generalConfig.data.textCommands)
        return;
    ...
    //HELP
    if (allowedCommands.includes("help"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:help", {
            name: "help",
            prefix,
            dmPermission: true,
    ...
    //PANEL
    if (allowedCommands.includes("panel"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:panel", {
            name: "panel",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //CLOSE
    if (allowedCommands.includes("close"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:close", {
            name: "close",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //DELETE
    if (allowedCommands.includes("delete"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:delete", {
            name: "delete",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //REOPEN
    if (allowedCommands.includes("reopen"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:reopen", {
            name: "reopen",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //CLAIM
    if (allowedCommands.includes("claim"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:claim", {
            name: "claim",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //UNCLAIM
    if (allowedCommands.includes("unclaim"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:unclaim", {
            name: "unclaim",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //PIN
    if (allowedCommands.includes("pin"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:pin", {
            name: "pin",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //UNPIN
    if (allowedCommands.includes("unpin"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:unpin", {
            name: "unpin",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //MOVE
    if (allowedCommands.includes("move"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:move", {
            name: "move",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //RENAME
    if (allowedCommands.includes("rename"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:rename", {
            name: "rename",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //ADD
    if (allowedCommands.includes("add"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:add", {
            name: "add",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //REMOVE
    if (allowedCommands.includes("remove"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:remove", {
            name: "remove",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //BLACKLIST
    if (allowedCommands.includes("blacklist"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:blacklist-view", {
            name: "blacklist view",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    if (allowedCommands.includes("blacklist"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:blacklist-add", {
            name: "blacklist add",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    if (allowedCommands.includes("blacklist"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:blacklist-remove", {
    ...
    if (allowedCommands.includes("blacklist"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:blacklist-get", {
            name: "blacklist get",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //STATS
    if (allowedCommands.includes("stats"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:stats-global", {
            name: "stats global",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    if (allowedCommands.includes("stats"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:stats-reset", {
            name: "stats reset",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    if (allowedCommands.includes("stats"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:stats-user", {
            name: "stats user",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    if (allowedCommands.includes("stats"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:stats-ticket", {
            name: "stats ticket",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //CLEAR
    if (allowedCommands.includes("clear"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:clear", {
            name: "clear",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //AUTOCLOSE
    if (allowedCommands.includes("autoclose"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:autoclose-disable", {
    ...
    if (allowedCommands.includes("autoclose"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:autoclose-enable", {
    ...
    //AUTODELETE
    if (allowedCommands.includes("autodelete"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:autodelete-disable", {
    ...
    if (allowedCommands.includes("autodelete"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:autodelete-enable", {
    ...
    if (allowedCommands.includes("topic"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:topic-set", {
            name: "topic set",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    if (allowedCommands.includes("priority"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:priority-set", {
            name: "priority set",
            prefix,
            dmPermission: false,
            guildPermission: true,
            ...
            options: [
                {
                    ...
                    required: true,
                    allowSpaces: false,
                    choices: index_1.opendiscord.priorities.getAll().sort((a, b) => b.priority - a.priority).map((prio) => prio.rawName)
                },
                {
                    name: "reason",
                    type: "string",
    ...
    if (allowedCommands.includes("priority"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:priority-get", {
            name: "priority get",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //TRANSFER
    if (allowedCommands.includes("transfer"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:transfer", {
            name: "transfer",
            prefix,
            dmPermission: false,
            guildPermission: true,
    ...
    //LEADERBOARD
    if (allowedCommands.includes("leaderboard"))
        commands.add(new index_1.api.ODTextCommand("opendiscord:leaderboard", {
            name: "leaderboard",
            prefix,
            dmPermission: false,
            guildPermission: true,
...
exports.loadAllTextCommands = loadAllTextCommands;
const loadAllContextMenus = async () => {
    const menus = index_1.opendiscord.client.contextMenus;
    const generalConfig = index_1.opendiscord.configs.get("opendiscord:general");
    if (!generalConfig)
        return;
    const act = discord.ApplicationCommandType;
...
exports.loadAllContextMenus = loadAllContextMenus;
