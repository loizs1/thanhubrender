...
export const loadAllDatabases = async () => {
    ...
    opendiscord.databases.add(defaultLeaderboardDatabase)
}
...
export const defaultLeaderboardDatabase = new api.ODJsonDatabase("opendiscord:leaderboard","leaderboard.json",(isDevdatabase) ? "./devdatabase/" : "./database/")
