...
export const loadAllSlashCommands = async () => {
    ...
    //LEADERBOARD
    if (allowedCommands.includes("leaderboard")) commands.add(new api.ODSlashCommand("opendiscord:leaderboard",{
        type:act.ChatInput,
        name:"leaderboard",
...
export const loadAllTextCommands = async () => {
    ...
    //LEADERBOARD
    if (allowedCommands.includes("leaderboard")) commands.add(new api.ODTextCommand("opendiscord:leaderboard",{
        name:"leaderboard",
        prefix,
        dmPermission:false,
        guildPermission:true,
