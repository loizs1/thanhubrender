...
export const registerButtonResponders = async () => {
    ...
    opendiscord.responders.buttons.get("opendiscord:transcript-error-retry").workers.add([
        new api.ODWorker("opendiscord:permissions",1,async (instance,params,source,cancel) => {
            const permsResult = await opendiscord.permissions.checkCommandPerms(generalConfig.data.system.permissions.delete,"support",instance.user,instance.member,instance.channel,instance.guild)
