...
export const registerCommandResponders = async () => {
    ...
    opendiscord.responders.commands.get("opendiscord:pin").workers.add([
        new api.ODWorker("opendiscord:permissions",1,async (instance,params,source,cancel) => {
            const permsResult = await opendiscord.permissions.checkCommandPerms(generalConfig.data.system.permissions.pin,"support",instance.user,instance.member,instance.channel,instance.guild)
