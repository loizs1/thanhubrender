...
export const registerButtonResponders = async () => {
    ...
    const closeTranscriptResponder = opendiscord.responders.buttons.get("opendiscord:close-ticket-transcript")
    if (closeTranscriptResponder){
        closeTranscriptResponder.workers.add(
